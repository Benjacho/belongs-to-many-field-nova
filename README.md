...
| `setRelatableDependencies` | Array           | []                 | If the options are dependent from other fields values (belongto, select). This method allows you fetch dependent options. You set the array of dependent fields attributes then you can use nova relatableQuery with selectedAttributeName request inputs (available when attribute value is not empty) to customize options query.                                                                  |
