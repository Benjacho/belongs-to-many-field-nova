...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-BelongsToManyField', __webpack_require__(5));
  Vue.component('detail-BelongsToManyField', __webpack_require__(11));
  Vue.component('form-BelongsToManyField', __webpack_require__(16));
});
...
/* scopeId */
var __vue_scopeId__ = "data-v-9e63f81a"
/* moduleIdentifier (server only) */
...
var update = __webpack_require__(1)("7333d52a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./IndexField.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./IndexField.vue");
...
// module
exports.push([module.i, "\n.single[data-v-9e63f81a]:not(:last-of-type):after {\n  content: ', ';\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        resourceValue: function resourceValue(value) {
        ...
        [
          _vm.field.viewable
            ? _c(
                ...
                [
                  _vm._v(
                    _vm._s(_vm.resourceValue(resource[_vm.field.optionsLabel]))
                  )
                ]
              )
            : _c("span", [
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("7f4ef86d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
// module
exports.push([module.i, "\n.single[data-v-0224618e]:not(:last-of-type):after {\n  content: ', ';\n}\n", ""]);
                          ...
                          ? _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm.resourceValue(
                                      resource[_vm.field.optionsLabel]
                                    )
                                  ) + "\n                        "
                                )
                              ]
                ...
                [
                  _vm.field.viewable
                    ...
                    : _c("span", [
                        _vm._v(
                          _vm._s(
                            _vm.resourceValue(resource[_vm.field.optionsLabel])
                          )
                        )
                      ])
                ],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("73287042", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("3cab5654", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(23);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    selectAll: function selectAll(value) {
      if (value) {
        this.value = [].concat(_toConsumableArray(this.options));
      } else {
        this.value = [];
      }
    }
      ...
      root.$children.forEach(function (component) {
        if (_this.componentIsDependency(component)) {
          if (component.selectedResourceId !== undefined) {
            ...
            component.$watch(attribute, _this.dependencyWatcher, { immediate: true });
    ...
    fetchOptions: function fetchOptions() {
      ...
      if (this.isDependant) {
        if (this.dependsOnValue) {
          this.loading = true;
          Nova.request(baseUrl + this.resourceName + "/" + "options/" + this.field.attribute + "/" + this.optionsLabel + "/" + this.dependsOnValue + "/" + this.field.dependsOnKey).then(function (data) {
